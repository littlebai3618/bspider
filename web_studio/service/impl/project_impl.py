...
from core.lib import PROJECT_TABLE, CODE_STORE_TABLE, CRON_JOB_STORE_TABLE, NODE_TABLE, P2C_TABLE, EXCHANGE_NAME
...
class ProjectImpl(BaseImpl):
    ...
    def __init__(self):
        ...
        self.cron_table = CRON_JOB_STORE_TABLE
        self.node_table = NODE_TABLE
        self.p2c_table = P2C_TABLE

...
# @File    : tools_impl
# @Use     :
from bspider.core import inner_settings


class ToolsImpl(object):

    def __init__(self):
        self.downloader_status_table = inner_settings.DOWNLOADER_STATUS_TABLE
        self.parser_status_table = inner_settings.PARSER_STATUS_TABLE
        self.handler = inner_settings.WEB_STUDIO_DB_HANDLER
